...
export default (function (targetDir, pkgManager) { return __awaiter(void 0, void 0, void 0, function () {
    var args, cmd;
    return __generator(this, function (_a) {
        args = PACKAGE_MANAGER_CONFIG[pkgManager];
        cmd = "".concat(pkgManager, " ").concat(args.join(" "));
        logger.log("\uD83D\uDE80  \u5B89\u88C5\u9879\u76EE\u4F9D\u8D56 ".concat(chalk.cyan(cmd), "\uFF0C\u8BF7\u7A0D\u7B49..."));
        return [2, new Promise(function (resolve, reject) {
                var child = execa(pkgManager, args, {
                    cwd: targetDir,
